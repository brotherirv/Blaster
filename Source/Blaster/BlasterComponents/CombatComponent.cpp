...
void UCombatComponent::ReloadEmptyWeapon()
{
	...
	{
		Reload();
		UE_LOG(LogTemp, Warning, TEXT("ReloadEmptyWeapon"));
	}
}
...
void UCombatComponent::FinishReloading()
{
	...
	//UE_LOG(LogTemp, Warning, TEXT("bLocallyReloading is:%s Finish Reloading Functino"), bLocallyReloading ? TEXT("true") : TEXT("false"));
