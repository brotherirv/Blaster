...
void UBlasterAnimInstance::NativeUpdateAnimation(float DeltaTime)
{
   ...
   {
        //LeftHandSocket
        LeftHandTransform = BlasterCharacter->GetMesh()->GetSocketTransform(FName("Hand_l"), ERelativeTransformSpace::RTS_World);
        FVector OutPosition;
        FRotator OutRotation;
        BlasterCharacter->GetMesh()->TransformToBoneSpace(FName("RightHandSocket"), LeftHandTransform.GetLocation(), FRotator::ZeroRotator, OutPosition, OutRotation);
